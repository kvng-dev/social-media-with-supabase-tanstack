  ...
  return (
    <div className="relative group">
      ...
      <Link to={`/post/${post.id}`} className="block relative z-10">
        <div className="w-[400px] h-[400px] bg-[rgb(24,27,32)] border border-[rgb(84,90,106)] rounded-[20px] text-white flex flex-col p-5 overflow-hidden transition-colors duration-300 group-hover:bg-gray-800">
          ...
          <div className="flex items-start space-x-2">
            ...
            <div className="flex flex-col flex-1">
              <div className="text-[18px] leading-[22px] font-semibold mt-2">
                {post.title}
              </div>
              <div className="text-[14px] mb-4 leading-[18px] text-gray-400 mt-1">
          ...
          <div className="mt-2 flex-1">
            <img
              src={post.image_url}
              alt={post.title}
              className="w-full rounded-[20px] object-cover max-h-[250px] mx-auto"
            />
          </div>
